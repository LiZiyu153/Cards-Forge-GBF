...
public enum Keyword {
    ...
    // =====================================================================
    // GBF (Granblue Fantasy) custom keywords — reserved extension slots.
    // Add GBF-specific keywords HERE so they don't get mixed into the
    // standard keyword pool. Copy the pattern of the placeholder below,
    // e.g.:  GBF_FOOBAR("GbfFoobar", SimpleKeyword.class, true, "reminder");
    // =====================================================================
    GBF_PLACEHOLDER("GbfPlaceholder", SimpleKeyword.class, true, ""),

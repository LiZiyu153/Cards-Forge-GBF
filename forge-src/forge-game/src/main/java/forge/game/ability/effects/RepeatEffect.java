...
public class RepeatEffect extends SpellAbilityEffect {
    ...
    public void resolve(final SpellAbility sa) {
        ...
        int count = 0;
        final int MAX_REPEAT_ITERATIONS = 1000; // hard safety cap against infinite loops (was Helm-of-Obedience-only)
        do {
            ...
            if (count >= MAX_REPEAT_ITERATIONS) {
                // TODO Replace Infinite Loop Break with a game draw. Here are the scenarios that can cause this:
                // Helm of Obedience vs Graveyard to Library replacement effect, or a badly-scripted Repeat
                ...
                infLoop.append("If this card's effect should loop longer, add MaxRepeat$ to its Repeat ability.");
